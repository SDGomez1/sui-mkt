      ...
      <section className="h-[calc(100svh-5rem)] flex justify-center items-center overflow-x-hidden">
        ...
        >
          ...
          <CardHeader>
            ...
            <CardContent>
              <Link href="/auth/signUp/password">
                <Button className="w-full mb-4 cursor-pointer" variant={"secondary"}>
                  Registrarse con correo electrónico
                </Button>
              </Link>
              <GoogleSignInButton className={cn(buttonVariants({variant:"secondary"}),"border-none m-0")}/>
            </CardContent>
